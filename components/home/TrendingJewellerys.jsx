...
const trendingItems = [
  {
    ...
    desc: "Sacred gold pieces for your most auspicious moments",
  ...
  },
  {
    ...
    desc: "VVS diamonds set in 18K white and yellow gold",
  ...
  },
  {
    ...
    tag: "Trending",
    title: "Ear Candy Edit",
    desc: "From subtle drops to bold chandeliers — all day, every day",
    price: "₹ 18,000 onwards",
  },
];

const TrendingJewellerys = () => (
  <>
    <style>{`
      ...
      .tj-card { background: #fff; border: 1px solid #EDE4D8; border-radius: 4px; overflow: hidden; transition: box-shadow 0.3s, transform 0.3s; cursor: pointer; }
      ...
      .tj-card-img-wrap img { width: 100%; height: 340px; object-fit: cover; display: block; transition: transform 0.6s ease; }
      .tj-card:hover .tj-card-img-wrap img { transform: scale(1.05); }
      .tj-tag { position: absolute; top: 14px; left: 14px; background: rgba(44,26,14,0.82); color: #D4AF6A; font-family: 'Jost', sans-serif; font-size: 9px; font-weight: 500; letter-spacing: 2px; padding: 5px 12px; text-transform: uppercase; backdrop-filter: blur(4px); border-radius: 2px; }
      .tj-card-body { padding: 20px 20px 22px; }
      .tj-card-title { font-family: 'Cormorant Garamond', serif; font-size: 22px; font-weight: 400; color: #2C1A0E; margin-bottom: 7px; }
      .tj-card-desc { font-family: 'Jost', sans-serif; font-size: 13px; color: #7A6656; line-height: 1.55; margin-bottom: 14px; font-weight: 300; }
      ...
      .tj-shop-btn { font-family: 'Jost', sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 1.5px; text-transform: uppercase; color: #B8862A; text-decoration: none; display: flex; align-items: center; gap: 5px; transition: gap 0.2s; }
    ...
    <section className="tj-section">
      <TitleSection title={'Trending <em>Now</em>'} subtitle="Jewellery pieces everyone's eyeing right now" width="1320px">
        <div className="tj-grid">
          {trendingItems.map((item, i) => (
            <Link href="/listing" key={i} className="tj-card" style={{ textDecoration: "none" }}>
